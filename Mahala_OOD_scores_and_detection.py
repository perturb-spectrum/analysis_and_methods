...
for epsilon in epsilonz:
    ...
    if epsilon < args.epsilon_test:
        ...
        scores_of_iD_data, scores_of_OOD_data = get_Mahala_scores(model, val_loader, epsilon, args.epsilon_test, device, args)
        ...
        torch.save(to_save, f'./scores/Mahala_{epsilon}_resnet18_eval_on_{args.epsilon_test}.pth')
        ...
        print(f'{epsilon}-robust-model evaluated on {args.epsilon_test}, AUROC {auroc}, TNR @ 95% TPR {tnr}')
