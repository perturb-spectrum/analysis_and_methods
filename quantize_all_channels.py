...
for epsilon in epsilonz:
    ...
    if args.model_name == 'resnet18':
        ...
        many_feature_full_quant_eval(model, val_loader, args.epsilon_test, device, args.data_dir, f'AT_{epsilon}_{args.model_name}_eval_on_{args.epsilon_test}', args, args.scale)
        ...
        model = model.to(device)
        many_feature_full_quant_eval_generic(model, val_loader, args.epsilon_test, device, args.data_dir, f'AT_{epsilon}_{args.model_name}_eval_on_{args.epsilon_test}', args, args.scale)
